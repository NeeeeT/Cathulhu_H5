...
box2d.b2MakeArray = function(a, b) {
    ...
    if ("function" === typeof b)
        for (var d = 0; d < a; ++d) c.push(b(d));
    else
        for (d = 0; d < a; ++d) c.push(null);
    return c
};
...
box2d.b2Simplex.prototype.ReadCache = function(a, b, c, d, e) {
    ...
    1 < this.m_count && (a = a.metric, g = this.GetMetric(), g < .5 * a || 2 * a < g || g < box2d.b2_epsilon) && (this.m_count = 0);
    0 === this.m_count &&
        (h = f[0], h.indexA = 0, h.indexB = 0, k = b.GetVertex(0), l = d.GetVertex(0), box2d.b2Mul_X_V2(c, k, h.wA), box2d.b2Mul_X_V2(e, l, h.wB), box2d.b2Sub_V2_V2(h.wB, h.wA, h.w), this.m_count = h.a = 1)
};
...
box2d.b2ShapeDistance = function(a, b, c) {
    ...
    a.iterations = p;
    h.WriteCache(b);
    c.useRadii && (b = d.m_radius, e = e.m_radius, a.distance > b + e && a.distance > box2d.b2_epsilon ? (a.distance -= b + e, c = box2d.b2Sub_V2_V2(a.pointB, a.pointA, box2d.b2Distance.s_normal), c.Normalize(), a.pointA.SelfMulAdd(b, c), a.pointB.SelfMulSub(e, c)) : (r = box2d.b2Mid_V2_V2(a.pointA, a.pointB, box2d.b2Distance.s_p),
...
box2d.b2AABB.prototype.RayCast = function(a, b) {
    ...
    } else if (k = 1 / g, g = (this.lowerBound.x - e) * k, e = (this.upperBound.x - e) * k, k = -1, g > e && (k = g, g = e, e = k, k = 1), g > c && (m.x = k, m.y = 0, c = g), d = box2d.b2Min(d, e), c > d) return !1;
    if (l < box2d.b2_epsilon) {
        if (f < this.lowerBound.y || this.upperBound.y < f) return !1
    } else if (k = 1 / h, g =
        (this.lowerBound.y - f) * k, e = (this.upperBound.y - f) * k, k = -1, g > e && (k = g, g = e, e = k, k = 1), g > c && (m.x = 0, m.y = k, c = g), d = box2d.b2Min(d, e), c > d) return !1;
...
box2d.b2ClipSegmentToLine = function(a, b, c, d, e) {
    ...
    0 >= h && a[f++].Copy(g);
    0 >= c && a[f++].Copy(b);
    0 > h * c && (c = h / (h - c), d = a[f].v, d.x = g.v.x + c * (b.v.x - g.v.x), d.y = g.v.y + c * (b.v.y - g.v.y), a = a[f].id, a.cf.indexA = e, a.cf.indexB = g.id.cf.indexB, a.cf.typeA = box2d.b2ContactFeatureType.e_vertex, a.cf.typeB = box2d.b2ContactFeatureType.e_face, ++f);
    return f
};
...
box2d.b2CollidePolygonAndCircle = function(a, b, c, d, e) {
    ...
    m = k[l];
    h = k[(l + 1) % h];
    g < box2d.b2_epsilon ? (a.pointCount = 1, a.type = box2d.b2ManifoldType.e_faceA,
        ...
        a.points[0].localPoint.Copy(d.m_p), a.points[0].id.key = 0)))
};
...
box2d.b2CollideEdgeAndCircle = function(a, b, c, d, e) {
    ...
    if (0 >=
        ...
        if (n =
            g, k = box2d.b2Sub_V2_V2(c, n, box2d.b2CollideEdgeAndCircle.s_d), k = box2d.b2Dot_V2_V2(k, k), !(k > m * m)) {
        ...
        a.points[0].id.Copy(e), a.points[0].localPoint.Copy(d.m_p))
};
...
box2d.b2EPCollider.prototype.Collide = function(a, b, c, d, e) {
    ...
    var f = box2d.b2Dot_V2_V2(this.m_normal1, box2d.b2Sub_V2_V2(this.m_centroidB, this.m_v1, box2d.b2Vec2.s_t0)),
        ...
        k = !1,
        l = !1;
    c && (g = box2d.b2Sub_V2_V2(this.m_v1, this.m_v0, box2d.b2EPCollider.s_edge0), g.Normalize(), this.m_normal0.Set(g.y, -g.x), k = 0 <= box2d.b2Cross_V2_V2(g, e), g = box2d.b2Dot_V2_V2(this.m_normal0, box2d.b2Sub_V2_V2(this.m_centroidB, this.m_v0, box2d.b2Vec2.s_t0)));
    b && (h = box2d.b2Sub_V2_V2(this.m_v3, this.m_v2, box2d.b2EPCollider.s_edge2), h.Normalize(), this.m_normal2.Set(h.y, -h.x), l = 0 < box2d.b2Cross_V2_V2(e, h), h = box2d.b2Dot_V2_V2(this.m_normal2, box2d.b2Sub_V2_V2(this.m_centroidB, this.m_v2, box2d.b2Vec2.s_t0)));
    ...
    f = 0;
    for (g = d.m_count; f < g; ++f) box2d.b2Mul_X_V2(this.m_xf, d.m_vertices[f], this.m_polygonB.vertices[f]),
    ...
    if (!(c.type === box2d.b2EPAxisType.e_unknown || c.separation > this.m_radius || (b = this.ComputePolygonSeparation(box2d.b2EPCollider.s_polygonAxis), b.type !== box2d.b2EPAxisType.e_unknown && b.separation > this.m_radius))) {
        ...
        } else a.type = box2d.b2ManifoldType.e_faceB, h = e[0], h.v.Copy(this.m_v1), h.id.cf.indexA = 0, h.id.cf.indexB = c.index, h.id.cf.typeA = box2d.b2ContactFeatureType.e_vertex,
            h.id.cf.typeB = box2d.b2ContactFeatureType.e_face, g = e[1], g.v.Copy(this.m_v2), g.id.cf.indexA = 0, g.id.cf.indexB = c.index, g.id.cf.typeA = box2d.b2ContactFeatureType.e_vertex, g.id.cf.typeB = box2d.b2ContactFeatureType.e_face, b.i1 = c.index, b.i2 = (b.i1 + 1) % this.m_polygonB.count, b.v1.Copy(this.m_polygonB.vertices[b.i1]), b.v2.Copy(this.m_polygonB.vertices[b.i2]), b.normal.Copy(this.m_polygonB.normals[b.i1]);
        ...
        if (!(g < box2d.b2_maxManifoldPoints || (g = box2d.b2ClipSegmentToLine(h, f, b.sideNormal2, b.sideOffset2, b.i2), g < box2d.b2_maxManifoldPoints))) {
            ...
            f = d = 0;
            for (g = box2d.b2_maxManifoldPoints; f < g; ++f) box2d.b2Dot_V2_V2(b.normal, box2d.b2Sub_V2_V2(h[f].v, b.v1, box2d.b2Vec2.s_t0)) <= this.m_radius && (e = a.points[d], c.type === box2d.b2EPAxisType.e_edgeA ? (box2d.b2MulT_X_V2(this.m_xf, h[f].v, e.localPoint), e.id = h[f].id) : (e.localPoint.Copy(h[f].v), e.id.cf.typeA = h[f].id.cf.typeB, e.id.cf.typeB = h[f].id.cf.typeA, e.id.cf.indexA = h[f].id.cf.indexB, e.id.cf.indexB = h[f].id.cf.indexA), ++d);
            a.pointCount = d
        }
    }
};
...
box2d.b2EPCollider.prototype.ComputePolygonSeparation = function(a) {
    ...
    for (var b = box2d.b2EPCollider.s_perp.Set(-this.m_normal.y, this.m_normal.x), c = 0, d = this.m_polygonB.count; c < d; ++c) {
        var e = box2d.b2EPCollider.s_n.Copy(this.m_polygonB.normals[c]).SelfNeg(),
            ...
            g = box2d.b2Dot_V2_V2(e, box2d.b2Sub_V2_V2(this.m_polygonB.vertices[c], this.m_v2,
                box2d.b2Vec2.s_t0)),
            f = box2d.b2Min(f, g);
        if (f > this.m_radius) {
...
box2d.b2CollidePolygons = function(a, b, c, d, e) {
    ...
    if (!(h > f)) {
        ...
        if (!(l > f)) {
            var m = 0,
                n = 0;
            l > .98 * h + .001 ? (h = d, d = b, b = e, m = k[0], a.type = box2d.b2ManifoldType.e_faceB, n = 1) : (h = b, b = c, c = e, m = g[0], a.type = box2d.b2ManifoldType.e_faceA, n = 0);
            g = box2d.b2CollidePolygons.s_incidentEdge;
            box2d.b2FindIncidentEdge(g, h, b, m,
                d, c);
            e = h.m_vertices;
            var k = m,
                h = (m + 1) % h.m_count,
            ...
            if (!(2 > g || (g = box2d.b2ClipSegmentToLine(p, u, l, r, h), 2 > g))) {
                ...
                a.localPoint.Copy(d);
                for (k = g = 0; k < box2d.b2_maxManifoldPoints; ++k) e = p[k], box2d.b2Dot_V2_V2(m, e.v) - b <= f && (h = a.points[g], box2d.b2MulT_X_V2(c, e.v, h.localPoint), h.id.Copy(e.id), n && (e = h.id.cf, h.id.cf.indexA =
                    e.indexB, h.id.cf.indexB = e.indexA, h.id.cf.typeA = e.typeB, h.id.cf.typeB = e.typeA), ++g);
                a.pointCount = g
            }
        }
    }
...
box2d.b2DynamicTree.prototype.RayCast = function(a, b) {
    if (null !== this.m_root) {
        ...
        h.upperBound.x = box2d.b2Max(c.x,
            k);
            ...
            if (k = m.Pop(), null !== k && box2d.b2TestOverlap_AABB(k.aabb, h)) {
                ...
                if (!(0 < box2d.b2Abs(box2d.b2Dot_V2_V2(e, box2d.b2Sub_V2_V2(c, l, box2d.b2Vec2.s_t0))) - box2d.b2Dot_V2_V2(f, n)))
                    if (k.IsLeaf()) {
                        ...
                        k = a(l, k);
                        if (0 === k) break;
                        0 < k && (g = k, k = c.x + g * (d.x - c.x), l = c.y + g * (d.y - c.y), h.lowerBound.x =
                            box2d.b2Min(c.x, k), h.lowerBound.y = box2d.b2Min(c.y, l), h.upperBound.x = box2d.b2Max(c.x, k), h.upperBound.y = box2d.b2Max(c.y, l))
    ...
    if (null === this.m_root) this.m_root = a, this.m_root.parent = null;
        ...
        for (var c = this.m_root, d, e; !c.IsLeaf();) {
            ...
            var h = g.GetPerimeter(),
                ...
                l, m;
            d.IsLeaf() ? (k.Combine2(b, d.aabb), f = k.GetPerimeter() + h) : (k.Combine2(b, d.aabb), l = d.aabb.GetPerimeter(), m = k.GetPerimeter(),
                f = m - l + h);
        ...
        for (c = a.parent; null !== c;) c = this.Balance(c), d = c.child1, e = c.child2, box2d.ENABLE_ASSERTS && box2d.b2Assert(null !==
            d), box2d.ENABLE_ASSERTS && box2d.b2Assert(null !== e), c.height = 1 + box2d.b2Max(d.height, e.height), c.aabb.Combine2(d.aabb, e.aabb), c = c.parent
    }
};
...
box2d.b2DynamicTree.prototype.Balance = function(a) {
    ...
    if (1 < d) {
        ...
        d.height > e.height ? (c.child2 = d, a.child2 = e, e.parent = a, a.aabb.Combine2(b.aabb, e.aabb), c.aabb.Combine2(a.aabb,
            d.aabb), a.height = 1 + box2d.b2Max(b.height, e.height), c.height = 1 + box2d.b2Max(a.height, d.height)) : (c.child2 = e, a.child2 = d, d.parent = a, a.aabb.Combine2(b.aabb, d.aabb), c.aabb.Combine2(a.aabb, e.aabb), a.height = 1 + box2d.b2Max(b.height, d.height), c.height = 1 + box2d.b2Max(a.height, e.height));
        return c
    }
    return -1 > d ? (d = b.child1, e = b.child2, b.child1 = a, b.parent = a.parent, a.parent = b, null !== b.parent ? b.parent.child1 === a ? b.parent.child1 = b : (box2d.ENABLE_ASSERTS && box2d.b2Assert(b.parent.child2 === a), b.parent.child2 = b) : this.m_root =
        b, d.height > e.height ? (b.child2 = d, a.child1 = e, e.parent = a, a.aabb.Combine2(c.aabb, e.aabb), b.aabb.Combine2(a.aabb, d.aabb), a.height = 1 + box2d.b2Max(c.height, e.height), b.height = 1 + box2d.b2Max(a.height, d.height)) : (b.child2 = e, a.child1 = d, d.parent = a, a.aabb.Combine2(c.aabb, d.aabb), b.aabb.Combine2(a.aabb, e.aabb), a.height = 1 + box2d.b2Max(c.height, d.height), b.height = 1 + box2d.b2Max(a.height, e.height)), b) : a
};
...
box2d.b2CircleShape.prototype.RayCast = function(a, b, c, d) {
    ...
    f = -(f + box2d.b2Sqrt(e));
    return 0 <= f && f <= b.maxFraction * g ? (f /= g, a.fraction =
        f, box2d.b2AddMul_V2_S_V2(c, f, d, a.normal).SelfNormalize(), !0) : !1
};
...
box2d.b2ChainShape.prototype.CreateLoop = function(a, b) {
    ...
    if (box2d.ENABLE_ASSERTS)
        for (var c = 1; c < b; ++c) box2d.b2Assert(box2d.b2DistanceSquared(a[c - 1], a[c]) > box2d.b2_linearSlop * box2d.b2_linearSlop);
    this.m_count = b + 1;
...
box2d.b2PolygonShape.prototype.SetAsBox = function(a, b, c, d) {
    ...
    if (c instanceof box2d.b2Vec2)
        for (d = "number" === typeof d ? d : 0, this.m_centroid.Copy(c), a = new box2d.b2Transform, a.SetPosition(c), a.SetRotationAngle(d), c = 0, d = this.m_count; c < d; ++c) box2d.b2Mul_X_V2(a,
            this.m_vertices[c], this.m_vertices[c]), box2d.b2Mul_R_V2(a.q, this.m_normals[c], this.m_normals[c]);
    return this
};
...
box2d.b2PolygonShape.prototype.Set = function(a, b, c) {
    ...
    b = e;
    if (3 > b) return box2d.ENABLE_ASSERTS &&
        box2d.b2Assert(!1), this.SetAsBox(1, 1);
    a = 0;
    g = d[0].x;
    for (f = 1; f < b; ++f)
    ...
    f = 0;
    for (b = c; f < b; ++f) d = box2d.b2Sub_V2_V2(this.m_vertices[(f + 1) % b], this.m_vertices[f], box2d.b2Vec2.s_t0), box2d.ENABLE_ASSERTS && box2d.b2Assert(d.LengthSquared() > box2d.b2_epsilon_sq), box2d.b2Cross_V2_S(d, 1, this.m_normals[f]).SelfNormalize();
...
box2d.b2PolygonShape.prototype.RayCast = function(a, b, c, d) {
    ...
    for (var e = box2d.b2MulT_X_V2(c, b.p2, box2d.b2PolygonShape.prototype.RayCast.s_p2), e = box2d.b2Sub_V2_V2(e, d, box2d.b2PolygonShape.prototype.RayCast.s_d), f = 0, g = b.maxFraction, h = -1, k = 0, l = this.m_count; k < l; ++k) {
        ...
        if (0 === n) {
            ...
            n && m < f * n ? (f = m / n, h = k) : 0 < n && m < g * n && (g = m / n);
        if (g < f) return !1
    }
...
box2d.b2PolygonShape.prototype.ComputeMass = function(a, b) {
    ...
    for (var k = 1 / 3, g = 0, h = this.m_count; g < h; ++g) {
        var l = box2d.b2Sub_V2_V2(this.m_vertices[g], f, box2d.b2PolygonShape.prototype.ComputeMass.s_e1),
            m = box2d.b2Sub_V2_V2(this.m_vertices[(g +
                1) % h], f, box2d.b2PolygonShape.prototype.ComputeMass.s_e2),
...
box2d.b2PolygonShape.prototype.ComputeSubmergedArea = function(a, b, c, d) {
    ...
    switch (h) {
        case 0:
            return l ? (a = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_md,
                this.ComputeMass(a, 1), box2d.b2Mul_X_V2(c, a.center, d), a.mass) : 0;
        case 1:
    ...
    b = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_outoVec.Set(this.m_vertices[b].x * (1 - g) + this.m_vertices[e].x * g, this.m_vertices[b].y *
        (1 - g) + this.m_vertices[e].y * g);
    g = 0;
    f = box2d.b2PolygonShape.prototype.ComputeSubmergedArea.s_center.SetZero();
    h = this.m_vertices[a];
    for (l = null; a !== e;) a = (a + 1) % this.m_count, l = a === e ? b : this.m_vertices[a], m = .5 * ((h.x - k.x) * (l.y - k.y) - (h.y - k.y) * (l.x - k.x)), g += m, f.x += m * (k.x + h.x + l.x) / 3, f.y += m * (k.y + h.y + l.y) / 3, h = l;
    f.SelfMul(1 / g);
...
box2d.b2SeparationFunction.prototype.Initialize = function(a, b, c, d, e, f) {
    ...
    1 === b ? (this.m_type = box2d.b2SeparationFunctionType.e_points, b = this.m_proxyA.GetVertex(a.indexA[0]), a = this.m_proxyB.GetVertex(a.indexB[0]), c = box2d.b2Mul_X_V2(c, b, box2d.b2TimeOfImpact.s_pointA),
        ...
        box2d.b2Mid_V2_V2(b, d, this.m_localPoint), c = box2d.b2Mul_X_V2(c, this.m_localPoint, box2d.b2TimeOfImpact.s_pointA), a = this.m_proxyB.GetVertex(a.indexB[0]), e = box2d.b2Mul_X_V2(e, a, box2d.b2TimeOfImpact.s_pointB), a = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(e, c, box2d.b2Vec2.s_t0), f)), 0 > a && (this.m_axis.SelfNeg(), a = -a));
    return a
};
...
box2d.b2SeparationFunction.prototype.FindMinSeparation = function(a, b, c) {
    ...
    switch (this.m_type) {
        ...
        case box2d.b2SeparationFunctionType.e_faceA:
            return c = box2d.b2Mul_R_V2(d.q, this.m_axis, box2d.b2TimeOfImpact.s_normal), d = box2d.b2Mul_X_V2(d, this.m_localPoint, box2d.b2TimeOfImpact.s_pointA), g = box2d.b2MulT_R_V2(e.q, box2d.b2Vec2.s_t0.Copy(c).SelfNeg(), box2d.b2TimeOfImpact.s_axisB), a[0] = -1, b[0] = this.m_proxyB.GetSupport(g), b = this.m_proxyB.GetVertex(b[0]), e = box2d.b2Mul_X_V2(e, b, box2d.b2TimeOfImpact.s_pointB), b = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(e, d, box2d.b2Vec2.s_t0), c);
        case box2d.b2SeparationFunctionType.e_faceB:
            return c = box2d.b2Mul_R_V2(e.q, this.m_axis, box2d.b2TimeOfImpact.s_normal), e = box2d.b2Mul_X_V2(e, this.m_localPoint, box2d.b2TimeOfImpact.s_pointB), f = box2d.b2MulT_R_V2(d.q, box2d.b2Vec2.s_t0.Copy(c).SelfNeg(), box2d.b2TimeOfImpact.s_axisA), b[0] = -1, a[0] = this.m_proxyA.GetSupport(f),
                a = this.m_proxyA.GetVertex(a[0]), d = box2d.b2Mul_X_V2(d, a, box2d.b2TimeOfImpact.s_pointA), b = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(d, e, box2d.b2Vec2.s_t0), c);
        default:
...
box2d.b2SeparationFunction.prototype.Evaluate = function(a, b, c) {
    ...
    switch (this.m_type) {
        case box2d.b2SeparationFunctionType.e_points:
            return a = this.m_proxyA.GetVertex(a), b = this.m_proxyB.GetVertex(b), d = box2d.b2Mul_X_V2(d, a, box2d.b2TimeOfImpact.s_pointA), e = box2d.b2Mul_X_V2(e, b, box2d.b2TimeOfImpact.s_pointB), d = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(e, d, box2d.b2Vec2.s_t0), this.m_axis);
        case box2d.b2SeparationFunctionType.e_faceA:
            return c =
                box2d.b2Mul_R_V2(d.q, this.m_axis, box2d.b2TimeOfImpact.s_normal), d = box2d.b2Mul_X_V2(d, this.m_localPoint, box2d.b2TimeOfImpact.s_pointA), b = this.m_proxyB.GetVertex(b), e = box2d.b2Mul_X_V2(e, b, box2d.b2TimeOfImpact.s_pointB), d = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(e, d, box2d.b2Vec2.s_t0), c);
        case box2d.b2SeparationFunctionType.e_faceB:
            return c = box2d.b2Mul_R_V2(e.q, this.m_axis, box2d.b2TimeOfImpact.s_normal), e = box2d.b2Mul_X_V2(e, this.m_localPoint, box2d.b2TimeOfImpact.s_pointB), a = this.m_proxyA.GetVertex(a), d = box2d.b2Mul_X_V2(d,
                a, box2d.b2TimeOfImpact.s_pointA), d = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(d, e, box2d.b2Vec2.s_t0), c);
        default:
            return box2d.ENABLE_ASSERTS && box2d.b2Assert(!1), 0
    }
};
...
box2d.b2Body.prototype.SetTransform_X_Y_A = function(a, b, c) {
    ...
    if (!this.m_world.IsLocked() && (this.m_xf.p.x !== a || this.m_xf.p.y !== b || this.m_xf.q.GetAngle() !== c))
        for (this.m_xf.q.SetAngle(c), this.m_xf.p.Set(a, b), this.m_xf0.Copy(this.m_xf), box2d.b2Mul_X_V2(this.m_xf, this.m_sweep.localCenter, this.m_sweep.c), this.m_sweep.a = c, this.m_sweep.c0.Copy(this.m_sweep.c), this.m_sweep.a0 = c, a = this.m_world.m_contactManager.m_broadPhase, b = this.m_fixtureList; b; b =
            b.m_next) b.Synchronize(a, this.m_xf, this.m_xf)
};
...
box2d.b2Body.prototype.ApplyForce = function(a, b, c) {
    this.m_type === box2d.b2BodyType.b2_dynamicBody && (!this.m_flag_awakeFlag && this.SetAwake(!0), this.m_flag_awakeFlag && (this.m_force.x += a.x, this.m_force.y += a.y, this.m_torque += (b.x - this.m_sweep.c.x) * a.y - (b.y - this.m_sweep.c.y) * a.x))
};
...
box2d.b2Body.prototype.ApplyLinearImpulse = function(a, b, c) {
    this.m_type === box2d.b2BodyType.b2_dynamicBody && (("boolean" === typeof c ? c : 1) && !this.m_flag_awakeFlag && this.SetAwake(!0), this.m_flag_awakeFlag && (this.m_linearVelocity.x += this.m_invMass * a.x, this.m_linearVelocity.y += this.m_invMass * a.y, this.m_angularVelocity += this.m_invI * ((b.x - this.m_sweep.c.x) * a.y - (b.y - this.m_sweep.c.y) * a.x)))
};
...
box2d.b2Body.prototype.ApplyLinearImpulseToCenter = function(a, b) {
    this.m_type === box2d.b2BodyType.b2_dynamicBody && (("boolean" === typeof b ? b : 1) && !this.m_flag_awakeFlag && this.SetAwake(!0), this.m_flag_awakeFlag && (this.m_linearVelocity.x += this.m_invMass * a.x, this.m_linearVelocity.y += this.m_invMass * a.y))
};
...
box2d.b2Body.prototype.SetType = function(a) {
    ...
    if (!this.m_world.IsLocked() && this.m_type !== a) {
        ...
        for (b = this.m_fixtureList; b; b = b.m_next)
            for (var c = b.m_proxyCount, d = 0; d < c; ++d) a.TouchProxy(b.m_proxies[d].proxy)
    }
};
...
box2d.b2Body.prototype.SetAwake = function(a) {
    a ? this.m_flag_awakeFlag || (this.m_flag_awakeFlag = !0, this.m_sleepTime = 0) : (this.m_flag_awakeFlag = !1, this.m_sleepTime = 0, this.m_linearVelocity.SetZero(), this.m_angularVelocity = 0, this.m_force.SetZero(), this.m_torque = 0)
};
...
box2d.b2ContactManager.prototype.AddPair = function(a, b) {
    ...
    if (g !== h) {
        for (var k = h.GetContactList(); k;) {
            ...
            e.m_nodeA, e.m_nodeB.contact = e, e.m_nodeB.other = g, e.m_nodeB.prev = null, e.m_nodeB.next = h.m_contactList, null !== h.m_contactList && (h.m_contactList.prev = e.m_nodeB), h.m_contactList = e.m_nodeB, c.IsSensor() || d.IsSensor() || (g.SetAwake(!0), h.SetAwake(!0)), ++this.m_contactCount))
    }
};
...
box2d.b2ContactSolver.prototype.Initialize = function(a) {
    ...
    for (b = this.m_count; a < b; ++a)
        for (e = this.m_contacts[a], f = e.m_fixtureA, g = e.m_fixtureB, c = f.GetShape(),
            ...
            (l.normalImpulse = 0, l.tangentImpulse = 0), l.rA.SetZero(), l.rB.SetZero(), l.normalMass = 0, l.tangentMass = 0, l.velocityBias = 0, e.localPoints[c].Copy(h.localPoint);
    return this
};
...
box2d.b2ContactSolver.prototype.InitializeVelocityConstraints = function() {
    var a, b, c, d, e, f, g, h, k, l, m, n, p, q, r, u, t, w, x, v, y = box2d.b2ContactSolver.prototype.InitializeVelocityConstraints.s_xfA,
    ...
    for (b = this.m_count; a < b; ++a) {
        ...
        box2d.b2Sub_V2_V2(w, box2d.b2Mul_R_V2(z.q, r, box2d.b2Vec2.s_t0),
            z.p);
        ...
        for (c = 0; c < d; ++c) g = e.points[c], box2d.b2Sub_V2_V2(B.points[c], f, g.rA), box2d.b2Sub_V2_V2(B.points[c], w, g.rB), q = box2d.b2Cross_V2_V2(g.rA, e.normal), r = box2d.b2Cross_V2_V2(g.rB, e.normal), q = l + m + n * q * q + p * r * r, g.normalMass = 0 < q ? 1 / q : 0, r = e.tangent, q = box2d.b2Cross_V2_V2(g.rA, r), r = box2d.b2Cross_V2_V2(g.rB, r), q = l + m + n * q * q + p * r * r, g.tangentMass = 0 < q ? 1 / q : 0, g.velocityBias = 0, q = box2d.b2Dot_V2_V2(e.normal, box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(v,
            k, g.rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(t, h, g.rA, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0)), q < -box2d.b2_velocityThreshold && (g.velocityBias += -e.restitution * q);
        2 === e.pointCount && box2d.g_blockSolve && (t = e.points[0], w = e.points[1], f = box2d.b2Cross_V2_V2(t.rA, e.normal), t = box2d.b2Cross_V2_V2(t.rB, e.normal), h = box2d.b2Cross_V2_V2(w.rA, e.normal), k = box2d.b2Cross_V2_V2(w.rB, e.normal), w = l + m + n * f * f + p * t * t, v = l + m + n * h * h + p * k * k, l = l + m + n * f * h + p * t * k, w * w < 1E3 * (w * v - l * l) ? (e.K.ex.Set(w, l), e.K.ey.Set(l, v), e.K.GetInverse(e.normalMass)) :
            e.pointCount = 1)
    }
};
...
box2d.b2ContactSolver.prototype.WarmStart = function() {
    ...
    for (b = this.m_count; a < b; ++a) {
        ...
        u = e.normal;
        t = e.tangent;
        for (c = 0; c < d; ++c) w = e.points[c], box2d.b2Add_V2_V2(box2d.b2Mul_S_V2(w.normalImpulse, u, box2d.b2Vec2.s_t0),
            box2d.b2Mul_S_V2(w.tangentImpulse, t, box2d.b2Vec2.s_t1), x), p -= k * box2d.b2Cross_V2_V2(w.rA, x), n.SelfMulSub(h, x), r += m * box2d.b2Cross_V2_V2(w.rB, x), q.SelfMulAdd(l, x);
...
box2d.b2ContactSolver.prototype.SolveVelocityConstraints = function() {
    var a, b, c, d, e, f, g, h, k, l, m, n, p, q, r, u, t, w, x, v, y = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_dv,
        ...
        E, F, G = box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_P,
        ...
        C =
        box2d.b2ContactSolver.prototype.SolveVelocityConstraints.s_x,
    ...
    for (b = this.m_count; a < b; ++a) {
        ...
        for (d = n; c < d; ++c) v = e.points[c], box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(r, u, v.rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(p, q, v.rA, box2d.b2Vec2.s_t1), y), E = box2d.b2Dot_V2_V2(y, w) - e.tangentSpeed, E = v.tangentMass * -E, F = x * v.normalImpulse, F = box2d.b2Clamp(v.tangentImpulse + E, -F, F), E = F - v.tangentImpulse, v.tangentImpulse = F, box2d.b2Mul_S_V2(E, w, G), p.SelfMulSub(h, G), q -=
            k * box2d.b2Cross_V2_V2(v.rA, G), r.SelfMulAdd(l, G), u += m * box2d.b2Cross_V2_V2(v.rB, G);
        if (1 !== e.pointCount && box2d.g_blockSolve)
            for (n = e.points[0], v = e.points[1], H.Set(n.normalImpulse, v.normalImpulse), box2d.ENABLE_ASSERTS && box2d.b2Assert(0 <= H.x && 0 <= H.y), box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(r, u, n.rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(p, q, n.rA, box2d.b2Vec2.s_t1), z), box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(r, u, v.rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(p, q, v.rA, box2d.b2Vec2.s_t1), B), c =
                box2d.b2Dot_V2_V2(z, t), d = box2d.b2Dot_V2_V2(B, t), I.x = c - n.velocityBias, I.y = d - v.velocityBias, I.SelfSub(box2d.b2Mul_M22_V2(e.K, H, box2d.b2Vec2.s_t0));;) {
                ...
                if (0 <= c && 0 <= d) {
                    ...
                    q -= k * (box2d.b2Cross_V2_V2(n.rA, K) + box2d.b2Cross_V2_V2(v.rA, J));
                    r.SelfMulAdd(l, D);
                    u += m * (box2d.b2Cross_V2_V2(n.rB,
                        K) + box2d.b2Cross_V2_V2(v.rB, J));
                    n.normalImpulse = C.x;
                    v.normalImpulse = C.y;
                    break
                }
...
box2d.b2PositionSolverManifold.prototype.Initialize = function(a, b, c, d) {
    ...
    switch (a.type) {
        case box2d.b2ManifoldType.e_circles:
            ...
            box2d.b2Mul_X_V2(c, a.localPoints[0],
                f);
        ...
        case box2d.b2ManifoldType.e_faceA:
            ...
            break;
        case box2d.b2ManifoldType.e_faceB:
            box2d.b2Mul_R_V2(c.q,
                a.localNormal, this.normal), box2d.b2Mul_X_V2(c, a.localPoint, g), box2d.b2Mul_X_V2(b, a.localPoints[d], h), this.separation = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(h, g, box2d.b2Vec2.s_t0), this.normal) - a.radiusA - a.radiusB, this.point.Copy(h), this.normal.SelfNeg()
    }
};
...
box2d.b2ContactSolver.prototype.SolvePositionConstraints = function() {
    var a, b, c, d, e, f, g, h, k, l, m, n, p, q, r, u, t, w = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_xfA,
        ...
        y, z, B, E = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_rA,
        F = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_rB,
        G, H = box2d.b2ContactSolver.prototype.SolvePositionConstraints.s_P,
        I =
        0;
    a = 0;
    for (b = this.m_count; a < b; ++a) {
        ...
        for (c = 0; c < d; ++c) w.q.SetAngle(r), x.q.SetAngle(t), box2d.b2Sub_V2_V2(q, box2d.b2Mul_R_V2(w.q, h, box2d.b2Vec2.s_t0), w.p), box2d.b2Sub_V2_V2(u, box2d.b2Mul_R_V2(x.q, m, box2d.b2Vec2.s_t0), x.p), v.Initialize(e, w, x, c), y = v.normal, z = v.point,
            B = v.separation, box2d.b2Sub_V2_V2(z, q, E), box2d.b2Sub_V2_V2(z, u, F), I = box2d.b2Min(I, B), z = box2d.b2Clamp(box2d.b2_baumgarte * (B + box2d.b2_linearSlop), -box2d.b2_maxLinearCorrection, 0), B = box2d.b2Cross_V2_V2(E, y), G = box2d.b2Cross_V2_V2(F, y), B = k + n + l * B * B + p * G * G, z = 0 < B ? -z / B : 0, box2d.b2Mul_S_V2(z, y, H), q.SelfMulSub(k, H), r -= l * box2d.b2Cross_V2_V2(E, H), u.SelfMulAdd(n, H), t += p * box2d.b2Cross_V2_V2(F, H);
...
box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints = function(a, b) {
    var c, d, e, f, g, h, k, l, m, n, p, q, r, u, t, w, x, v = box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_xfA,
        ...
        B, E, F, G = box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_rA,
        H = box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_rB,
        I, C = box2d.b2ContactSolver.prototype.SolveTOIPositionConstraints.s_P,
        A = 0;
    c = 0;
    for (d = this.m_count; c < d; ++c) {
        ...
        w = this.m_positions[k].c;
        x = this.m_positions[k].a;
        for (e = 0; e < f; ++e) v.q.SetAngle(t), y.q.SetAngle(x), box2d.b2Sub_V2_V2(u, box2d.b2Mul_R_V2(v.q, l, box2d.b2Vec2.s_t0), v.p), box2d.b2Sub_V2_V2(w, box2d.b2Mul_R_V2(y.q, m, box2d.b2Vec2.s_t0),
            y.p), z.Initialize(g, v, y, e), B = z.normal, E = z.point, F = z.separation, box2d.b2Sub_V2_V2(E, u, G), box2d.b2Sub_V2_V2(E, w, H), A = box2d.b2Min(A, F), E = box2d.b2Clamp(box2d.b2_toiBaumgarte * (F + box2d.b2_linearSlop), -box2d.b2_maxLinearCorrection, 0), F = box2d.b2Cross_V2_V2(G, B), I = box2d.b2Cross_V2_V2(H, B), F = n + q + p * F * F + r * I * I, E = 0 < F ? -E / F : 0, box2d.b2Mul_S_V2(E, B, C), u.SelfMulSub(n, C), t -= p * box2d.b2Cross_V2_V2(G, C), w.SelfMulAdd(q, C), x += r * box2d.b2Cross_V2_V2(H, C);
...
box2d.b2Island.prototype.Solve = function(a, b, c, d) {
    ...
    for (g = 0; g < this.m_bodyCount; ++g) {
        var k = this.m_positions[g].c,
            ...
            p = box2d.b2Mul_S_V2(f, m,
                box2d.b2Island.s_translation);
    ...
    for (g = 0; g <
        this.m_bodyCount; ++g) b = this.m_bodies[g], b.m_sweep.c.Copy(this.m_positions[g].c), b.m_sweep.a = this.m_positions[g].a, b.m_linearVelocity.Copy(this.m_velocities[g].v), b.m_angularVelocity = this.m_velocities[g].w, b.SynchronizeTransform();
    ...
    if (d) {
        ...
        for (g = 0; g < this.m_bodyCount; ++g) h = this.m_bodies[g],
            h.GetType() !== box2d.b2BodyType.b2_staticBody && (!h.m_flag_autoSleepFlag || h.m_angularVelocity * h.m_angularVelocity > e || box2d.b2Dot_V2_V2(h.m_linearVelocity, h.m_linearVelocity) > d ? a = h.m_sleepTime = 0 : (h.m_sleepTime += f, a = box2d.b2Min(a, h.m_sleepTime)));
...
box2d.b2AreaJoint.prototype.SolveVelocityConstraints = function(a) {
    for (var b = 0, c = 0, d = 0, e = this.m_bodies.length; d < e; ++d) var f = this.m_bodies[d],
    ...
    this.m_impulse += b;
    d = 0;
    for (e = this.m_bodies.length; d < e; ++d) f = this.m_bodies[d], g = a.velocities[f.m_islandIndex].v, h = this.m_deltas[d], g.x += f.m_invMass * h.y * .5 * b, g.y += f.m_invMass * -h.x * .5 * b
};
...
box2d.b2AreaJoint.prototype.SolvePositionConstraints = function(a) {
    ...
    c = !0;
    d = 0;
    for (e = this.m_bodies.length; d < e; ++d) f = this.m_bodies[d], f = a.positions[f.m_islandIndex].c,
        h = box2d.b2Add_V2_V2(this.m_normals[d], this.m_normals[(d + 1) % e], this.m_delta), h.SelfMul(b), g = h.LengthSquared(), g > box2d.b2Sq(box2d.b2_maxLinearCorrection) && h.SelfMul(box2d.b2_maxLinearCorrection / box2d.b2Sqrt(g)), g > box2d.b2Sq(box2d.b2_linearSlop) && (c = !1), f.x += h.x, f.y += h.y;
    return c
};
...
box2d.b2DistanceJoint.prototype.SolvePositionConstraints = function(a) {
    ...
    var k = this.m_u.Normalize() - this.m_length,
        k = box2d.b2Clamp(k, -box2d.b2_maxLinearCorrection,
...
box2d.b2FrictionJoint.prototype.InitVelocityConstraints = function(a) {
    ...
    a.step.warmStarting ? (this.m_linearImpulse.SelfMul(a.step.dtRatio), this.m_angularImpulse *= a.step.dtRatio, g = this.m_linearImpulse, b.SelfMulSub(d, g), c -= l * (box2d.b2Cross_V2_V2(this.m_rA, g) + this.m_angularImpulse), e.SelfMulAdd(k, g), f += m * (box2d.b2Cross_V2_V2(this.m_rB, g) + this.m_angularImpulse)) : (this.m_linearImpulse.SetZero(), this.m_angularImpulse =
        0);
    a.velocities[this.m_indexA].w = c;
...
box2d.b2FrictionJoint.prototype.SolveVelocityConstraints = function(a) {
    ...
    c -= h * n;
    e += k * n;
    m = box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(d,
        e, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(b, c, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2FrictionJoint.prototype.SolveVelocityConstraints.s_Cdot);
...
box2d.b2World.prototype.DestroyBody = function(a) {
    ...
    if (!this.IsLocked()) {
        ...
        for (b = a.m_fixtureList; b;) c = b, b = b.m_next, this.m_destructionListener && this.m_destructionListener.SayGoodbyeFixture(c), c.DestroyProxies(this.m_contactManager.m_broadPhase), c.Destroy(), a.m_fixtureList = b, --a.m_fixtureCount;
...
box2d.b2World.prototype.Solve = function(a) {
    ...
    for (var d = this.m_contactManager.m_contactList; d; d =
        d.m_next) d.m_flag_islandFlag = !1;
        ...
        if (!f.m_flag_islandFlag && f.IsAwake() && f.IsActive() && f.GetType() !== box2d.b2BodyType.b2_staticBody) {
            ...
            for (f.m_flag_islandFlag = !0; 0 < g;)
                if (b = e[--g], box2d.ENABLE_ASSERTS && box2d.b2Assert(b.IsActive()), c.AddBody(b), b.SetAwake(!0), b.GetType() !== box2d.b2BodyType.b2_staticBody) {
                    ...
                    for (b = b.m_jointList; b; b = b.next) b.joint.m_islandFlag || (k = b.other, k.IsActive() && (c.AddJoint(b.joint), b.joint.m_islandFlag = !0, k.m_flag_islandFlag || (box2d.ENABLE_ASSERTS && box2d.b2Assert(g < d), e[g++] = k, k.m_flag_islandFlag = !0)))
...
box2d.b2World.prototype.QueryShape = function(a, b, c, d) {
    ...
    if (a instanceof box2d.b2QueryCallback)
        for (d = this.m_particleSystemList; d; d =
            d.m_next) a.ShouldQueryParticleSystem(d) && d.QueryAABB(a, f)
};
...
box2d.b2World.prototype.QueryPoint = function(a, b, c) {
    ...
    if (a instanceof box2d.b2QueryCallback)
        for (c = this.m_particleSystemList; c; c =
            c.m_next) a.ShouldQueryParticleSystem(c) && c.QueryAABB(a, e)
};
    ...
    d.RayCast(function(e, g) {
        ...
        if (k.RayCast(l, e, h.childIndex)) {
            ...
            return a instanceof box2d.b2RayCastCallback ?
                a.ReportFixture(k, m, l.normal, h) : a(k, m, l.normal, h)
        }
        return e.maxFraction
    }, e);
    if (a instanceof box2d.b2RayCastCallback)
        for (e = this.m_particleSystemList; e; e = e.m_next) a.ShouldQueryParticleSystem(e) && e.RayCast(a, b, c)
};
...
box2d.b2World.prototype.DrawShape = function(a, b) {
    ...
    switch (c.m_type) {
        ...
        case box2d.b2ShapeType.e_chainShape:
            ...
            for (var g = 1; g < d; ++g) e = f[g], this.m_debugDraw.DrawSegment(c, e, b), this.m_debugDraw.DrawCircle(e, .05, b), c = e;
            break;
    ...
    if (null !== this.m_debugDraw) {
        ...
        if (a & box2d.b2DrawFlags.e_shapeBit)
            for (var c = this.m_bodyList; c; c = c.m_next) {
                ...
                for (var e = c.GetFixtureList(); e; e = e.m_next) c.IsActive() ? c.GetType() === box2d.b2BodyType.b2_staticBody ? b.SetRGB(.5, .9, .5) : c.GetType() === box2d.b2BodyType.b2_kinematicBody ? b.SetRGB(.5, .5, .9) : c.IsAwake() ? b.SetRGB(.9,
                    .7, .7) : b.SetRGB(.6, .6, .6) : b.SetRGB(.5, .5, .3), this.DrawShape(e, b);
                this.m_debugDraw.PopTransform(d)
            }
        if (a & box2d.b2DrawFlags.e_particleBit)
            for (c = this.m_particleSystemList; c; c = c.m_next) this.DrawParticleSystem(c);
        ...
        if (a & box2d.b2DrawFlags.e_centerOfMassBit)
            for (c = this.m_bodyList; c; c = c.m_next) d = box2d.b2World.prototype.DrawDebugData.s_xf, d.q.Copy(c.m_xf.q), d.p.Copy(c.GetWorldCenter()), this.m_debugDraw.DrawTransform(d);
        if (a & box2d.b2DrawFlags.e_controllerBit)
            for (a =
                this.m_controllerList; a; a = a.m_next) a.Draw(this.m_debugDraw)
    }
};
...
box2d.b2World.prototype.Dump = function() {
    if (box2d.DEBUG && !this.m_flag_locked) {
        ...
        for (var a = 0, b = this.m_bodyList; b; b = b.m_next) b.m_islandIndex = a, b.Dump(),
            ++a;
        a = 0;
...
box2d.b2MotorJoint.prototype.InitVelocityConstraints = function(a) {
    ...
    a.step.warmStarting ? (this.m_linearImpulse.SelfMul(a.step.dtRatio), this.m_angularImpulse *=
        a.step.dtRatio, b = this.m_linearImpulse, d.SelfMulSub(p, b), e -= r * (box2d.b2Cross_V2_V2(n, b) + this.m_angularImpulse), h.SelfMulAdd(q, b), k += u * (box2d.b2Cross_V2_V2(m, b) + this.m_angularImpulse)) : (this.m_linearImpulse.SetZero(), this.m_angularImpulse = 0);
...
box2d.b2MouseJoint.prototype.InitVelocityConstraints = function(a) {
    ...
    var b = a.positions[this.m_indexB].c,
        ...
        g = a.step.dt;
    box2d.ENABLE_ASSERTS &&
        box2d.b2Assert(h + g * f > box2d.b2_epsilon);
    ...
    this.m_C.x =
        b.x + this.m_rB.x - this.m_targetA.x;
    this.m_C.y = b.y + this.m_rB.y - this.m_targetA.y;
    this.m_C.SelfMul(this.m_beta);
    d *= .98;
    a.step.warmStarting ? (this.m_impulse.SelfMul(a.step.dtRatio), c.x += this.m_invMassB * this.m_impulse.x, c.y += this.m_invMassB * this.m_impulse.y, d += this.m_invIB * box2d.b2Cross_V2_V2(this.m_rB, this.m_impulse)) : this.m_impulse.SetZero();
...
box2d.b2PrismaticJoint.prototype.InitVelocityConstraints = function(a) {
    ...
    var m = box2d.b2Mul_R_V2(f, this.m_lalcB, this.m_rB),
        n = box2d.b2Add_V2_V2(box2d.b2Sub_V2_V2(e, b, box2d.b2Vec2.s_t0),
            box2d.b2Sub_V2_V2(m, l, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.InitVelocityConstraints.s_d),
        b = this.m_invMassA,
        e = this.m_invMassB,
        f = this.m_invIA,
        p = this.m_invIB;
    ...
    box2d.b2Mul_R_V2(k, this.m_localYAxisA,
        this.m_perp);
    ...
    this.m_K.ez.z = b + e + f * this.m_a1 *
        this.m_a1 + p * this.m_a2 * this.m_a2;
    this.m_enableLimit ? (k = box2d.b2Dot_V2_V2(this.m_axis, n), box2d.b2Abs(this.m_upperTranslation - this.m_lowerTranslation) < 2 * box2d.b2_linearSlop ? this.m_limitState = box2d.b2LimitState.e_equalLimits : k <= this.m_lowerTranslation ? this.m_limitState !== box2d.b2LimitState.e_atLowerLimit && (this.m_limitState = box2d.b2LimitState.e_atLowerLimit, this.m_impulse.z = 0) : k >= this.m_upperTranslation ? this.m_limitState !== box2d.b2LimitState.e_atUpperLimit && (this.m_limitState = box2d.b2LimitState.e_atUpperLimit,
        this.m_impulse.z = 0) : (this.m_limitState = box2d.b2LimitState.e_inactiveLimit, this.m_impulse.z = 0)) : (this.m_limitState = box2d.b2LimitState.e_inactiveLimit, this.m_impulse.z = 0);
    this.m_enableMotor || (this.m_motorImpulse = 0);
    a.step.warmStarting ? (this.m_impulse.SelfMulScalar(a.step.dtRatio), this.m_motorImpulse *= a.step.dtRatio, k = box2d.b2Add_V2_V2(box2d.b2Mul_S_V2(this.m_impulse.x, this.m_perp, box2d.b2Vec2.s_t0), box2d.b2Mul_S_V2(this.m_motorImpulse + this.m_impulse.z, this.m_axis, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.InitVelocityConstraints.s_P),
        l = this.m_impulse.x * this.m_s1 + this.m_impulse.y + (this.m_motorImpulse + this.m_impulse.z) * this.m_a1, m = this.m_impulse.x * this.m_s2 + this.m_impulse.y + (this.m_motorImpulse + this.m_impulse.z) * this.m_a2, c.SelfMulSub(b, k), d -= f * l, g.SelfMulAdd(e, k), h += p * m) : (this.m_impulse.SetZero(), this.m_motorImpulse = 0);
    a.velocities[this.m_indexA].w = d;
    a.velocities[this.m_indexB].w = h
};
...
box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints = function(a) {
    ...
    var n = box2d.b2Dot_V2_V2(this.m_perp, box2d.b2Sub_V2_V2(d, b, box2d.b2Vec2.s_t0)) + this.m_s2 * e - this.m_s1 * c,
        p = e - c;
    this.m_enableLimit && this.m_limitState !== box2d.b2LimitState.e_inactiveLimit ? (l = box2d.b2Dot_V2_V2(this.m_axis,
        ...
        this.m_s2 + l.y + l.z * this.m_a2) : (l = this.m_K.Solve22(-n, -p, box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_df2), this.m_impulse.x += l.x, this.m_impulse.y += l.y, m = box2d.b2Mul_S_V2(l.x, this.m_perp, box2d.b2PrismaticJoint.prototype.SolveVelocityConstraints.s_P), n = l.x * this.m_s1 + l.y, l = l.x * this.m_s2 + l.y);
    b.SelfMulSub(f, m);
    c -= h * n;
    d.SelfMulAdd(g, m);
    a.velocities[this.m_indexA].w = c;
...
box2d.b2PrismaticJoint.prototype.SolvePositionConstraints = function(a) {
    var b = a.positions[this.m_indexA].c,
        ...
        q = box2d.b2Sub_V2_V2(box2d.b2Add_V2_V2(d, p, box2d.b2Vec2.s_t0), box2d.b2Add_V2_V2(b, n, box2d.b2Vec2.s_t1),
    ...
    if (z) {
        ...
        H.ez.Set(E, F, G);
        x = H.Solve33(-v, -y, -B, x)
    } else q = l * t + m * w, z = l + m, 0 === z && (z = 1), B = this.m_K2, B.ex.Set(h + k + l * t * t + m * w * w, q), B.ey.Set(q, z), v = B.Solve(-v, -y, box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_impulse1), x.x = v.x, x.y = v.y, x.z = 0;
    r = box2d.b2Add_V2_V2(box2d.b2Mul_S_V2(x.x,
        f, box2d.b2Vec2.s_t0), box2d.b2Mul_S_V2(x.z, r, box2d.b2Vec2.s_t1), box2d.b2PrismaticJoint.prototype.SolvePositionConstraints.s_P);
    u = x.x * t + x.y + x.z * u;
    g = x.x * w + x.y + x.z * g;
    b.SelfMulSub(h, r);
    c -= l * u;
...
box2d.b2RevoluteJoint.prototype.InitVelocityConstraints = function(a) {
    ...
    var h = this.m_invMassA,
        ...
        m = this.m_invIB,
        n = 0 === l + m;
    this.m_mass.ex.x = h + k + this.m_rA.y * this.m_rA.y * l + this.m_rB.y *
        this.m_rB.y * m;
...
box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints = function(a) {
    ...
    this.m_enableLimit && this.m_limitState !== box2d.b2LimitState.e_inactiveLimit && !l ? (l = box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(d, e, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(b, c, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_Cdot1), m = this.m_mass.Solve33(l.x, l.y, e - c, box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_impulse3).SelfNeg(), this.m_limitState === box2d.b2LimitState.e_equalLimits ? this.m_impulse.SelfAdd(m) :
        ...
        e, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(b, c, this.m_rA, box2d.b2Vec2.s_t1), box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_Cdot), m = this.m_mass.Solve22(-m.x, -m.y, box2d.b2RevoluteJoint.prototype.SolveVelocityConstraints.s_impulse2), this.m_impulse.x += m.x, this.m_impulse.y += m.y, b.SelfMulSub(f, m), c -= h * box2d.b2Cross_V2_V2(this.m_rA, m), d.SelfMulAdd(g, m), e += k * box2d.b2Cross_V2_V2(this.m_rB, m));
    a.velocities[this.m_indexA].w = c;
    a.velocities[this.m_indexB].w = e
};
...
box2d.b2GearJoint = function(a) {
    ...
    this.m_typeA === box2d.b2JointType.e_revoluteJoint ? (c = a.joint1, this.m_localAnchorC.Copy(c.m_localAnchorA), this.m_localAnchorA.Copy(c.m_localAnchorB), this.m_referenceAngleA = c.m_referenceAngle, this.m_localAxisC.SetZero(), b = d - e - this.m_referenceAngleA) : (e = a.joint1, this.m_localAnchorC.Copy(e.m_localAnchorA),
        this.m_localAnchorA.Copy(e.m_localAnchorB), this.m_referenceAngleA = e.m_referenceAngle, this.m_localAxisC.Copy(e.m_localXAxisA), d = this.m_localAnchorC, b = box2d.b2MulT_R_V2(c.q, box2d.b2Add_V2_V2(box2d.b2Mul_R_V2(b.q, this.m_localAnchorA, box2d.b2Vec2.s_t0), box2d.b2Sub_V2_V2(b.p, c.p, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), b = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(b, d, box2d.b2Vec2.s_t0), this.m_localAxisC));
    ...
    this.m_typeB === box2d.b2JointType.e_revoluteJoint ? (c = a.joint2, this.m_localAnchorD.Copy(c.m_localAnchorA), this.m_localAnchorB.Copy(c.m_localAnchorB), this.m_referenceAngleB = c.m_referenceAngle, this.m_localAxisD.SetZero(), c = e - f - this.m_referenceAngleB) : (e = a.joint2, this.m_localAnchorD.Copy(e.m_localAnchorA), this.m_localAnchorB.Copy(e.m_localAnchorB), this.m_referenceAngleB = e.m_referenceAngle, this.m_localAxisD.Copy(e.m_localXAxisA),
        e = this.m_localAnchorD, c = box2d.b2MulT_R_V2(d.q, box2d.b2Add_V2_V2(box2d.b2Mul_R_V2(c.q, this.m_localAnchorB, box2d.b2Vec2.s_t0), box2d.b2Sub_V2_V2(c.p, d.p, box2d.b2Vec2.s_t1), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), c = box2d.b2Dot_V2_V2(box2d.b2Sub_V2_V2(c, e, box2d.b2Vec2.s_t0), this.m_localAxisD));
    this.m_ratio = a.ratio;
...
box2d.b2GearJoint.prototype.InitVelocityConstraints = function(a) {
    ...
    this.m_typeB === box2d.b2JointType.e_revoluteJoint ? (this.m_JvBD.SetZero(), this.m_JwD = this.m_JwB = this.m_ratio, this.m_mass += this.m_ratio * this.m_ratio * (this.m_iB +
        ...
        l), this.m_JwB = this.m_ratio * box2d.b2Cross_V2_V2(d, l), this.m_mass += this.m_ratio * this.m_ratio * (this.m_mD + this.m_mB) + this.m_iD * this.m_JwD * this.m_JwD + this.m_iB * this.m_JwB * this.m_JwB);
    this.m_mass = 0 < this.m_mass ? 1 / this.m_mass : 0;
    a.step.warmStarting ? (b.SelfMulAdd(this.m_mA * this.m_impulse, this.m_JvAC), c += this.m_iA * this.m_impulse * this.m_JwA, e.SelfMulAdd(this.m_mB * this.m_impulse, this.m_JvBD), f += this.m_iB * this.m_impulse * this.m_JwB, h.SelfMulSub(this.m_mC * this.m_impulse, this.m_JvAC), k -= this.m_iC * this.m_impulse * this.m_JwC,
        m.SelfMulSub(this.m_mD * this.m_impulse, this.m_JvBD), n -= this.m_iD * this.m_impulse * this.m_JwD) : this.m_impulse = 0;
    a.velocities[this.m_indexA].w = c;
    a.velocities[this.m_indexB].w = f;
...
box2d.b2GearJoint.prototype.SolveVelocityConstraints = function(a) {
    var b = a.velocities[this.m_indexA].v,
        ...
        l = l + (this.m_JwA * c - this.m_JwC * g +
            (this.m_JwB * e - this.m_JwD * k)),
        l = -this.m_mass * l;
    this.m_impulse += l;
...
box2d.b2GearJoint.prototype.SolvePositionConstraints = function(a) {
    ...
    if (this.m_typeA === box2d.b2JointType.e_revoluteJoint) q.SetZero(),
        l = u = 1, w += this.m_iA + this.m_iC, n = c - g - this.m_referenceAngleA;
    else {
        ...
        t = this.m_lalcC;
        n = box2d.b2MulT_R_V2(n,
            box2d.b2Add_V2_V2(x, box2d.b2Sub_V2_V2(b, f, box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0), box2d.b2Vec2.s_t0);
    ...
    p =
        n + this.m_ratio * p - this.m_constant;
    n = 0;
    0 < w && (n = -p / w);
...
box2d.b2RopeJoint.prototype.InitVelocityConstraints = function(a) {
    ...
    this.m_length > box2d.b2_linearSlop ? (this.m_u.SelfMul(1 / this.m_length), b = box2d.b2Cross_V2_V2(this.m_rA, this.m_u), e = box2d.b2Cross_V2_V2(this.m_rB, this.m_u), b = this.m_invMassA + this.m_invIA * b * b + this.m_invMassB + this.m_invIB * e * e, this.m_mass = 0 !== b ? 1 / b : 0, a.step.warmStarting ? (this.m_impulse *= a.step.dtRatio, b = box2d.b2Mul_S_V2(this.m_impulse, this.m_u, box2d.b2RopeJoint.prototype.InitVelocityConstraints.s_P),
        c.SelfMulSub(this.m_invMassA, b), d -= this.m_invIA * box2d.b2Cross_V2_V2(this.m_rA, b), g.SelfMulAdd(this.m_invMassB, b), h += this.m_invIB * box2d.b2Cross_V2_V2(this.m_rB, b)) : this.m_impulse = 0, a.velocities[this.m_indexA].w = d, a.velocities[this.m_indexB].w = h) : (this.m_u.SetZero(), this.m_impulse = this.m_mass = 0)
};
...
box2d.b2WeldJoint.prototype.InitVelocityConstraints = function(a) {
    ...
    var h = this.m_invMassA,
        ...
        m = this.m_invIB,
        n = this.m_K;
    n.ex.x = h + k + this.m_rA.y * this.m_rA.y * l + this.m_rB.y *
        this.m_rB.y * m;
    ...
    a.step.warmStarting ? (this.m_impulse.SelfMulScalar(a.step.dtRatio), n = box2d.b2WeldJoint.prototype.InitVelocityConstraints.s_P.Set(this.m_impulse.x, this.m_impulse.y), c.SelfMulSub(h, n), d -= l * (box2d.b2Cross_V2_V2(this.m_rA, n) + this.m_impulse.z), f.SelfMulAdd(k, n), g += m * (box2d.b2Cross_V2_V2(this.m_rB, n) + this.m_impulse.z)) : this.m_impulse.SetZero();
    a.velocities[this.m_indexA].w = d;
    a.velocities[this.m_indexB].w = g
};
...
box2d.b2WeldJoint.prototype.SolveVelocityConstraints = function(a) {
    ...
    if (0 < this.m_frequencyHz) {
        ...
        c -= h * l;
        e += k * l;
        l = box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(d, e, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(b, c,
            this.m_rA, box2d.b2Vec2.s_t1), box2d.b2WeldJoint.prototype.SolveVelocityConstraints.s_Cdot1);
        ...
        var l = box2d.b2Sub_V2_V2(box2d.b2AddCross_V2_S_V2(d, e, this.m_rB, box2d.b2Vec2.s_t0), box2d.b2AddCross_V2_S_V2(b, c, this.m_rA, box2d.b2Vec2.s_t1),
...
box2d.b2WeldJoint.prototype.SolvePositionConstraints = function(a) {
    ...
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
    var p =
        box2d.b2Mul_R_V2(g, this.m_lalcB, this.m_rB),
        q = this.m_K;
...
box2d.b2WheelJoint.prototype.InitVelocityConstraints = function(a) {
    ...
    f =
        box2d.b2Sub_V2_V2(box2d.b2Add_V2_V2(k, q, box2d.b2Vec2.s_t0), box2d.b2Add_V2_V2(f, l, box2d.b2Vec2.s_t1), box2d.b2WheelJoint.prototype.InitVelocityConstraints.s_d);
    ...
    0 < this.m_frequencyHz ?
        (box2d.b2Mul_R_V2(p, this.m_localXAxisA, this.m_ax), this.m_sAx = box2d.b2Cross_V2_V2(box2d.b2Add_V2_V2(f, l, box2d.b2Vec2.s_t0), this.m_ax), this.m_sBx = box2d.b2Cross_V2_V2(q, this.m_ax), b = b + c + d * this.m_sAx * this.m_sAx + e * this.m_sBx * this.m_sBx, 0 < b && (this.m_springMass = 1 / b, c = box2d.b2Dot_V2_V2(f, this.m_ax), p = 2 * box2d.b2_pi * this.m_frequencyHz, f = this.m_springMass * p * p, k = a.step.dt, this.m_gamma = k * (2 * this.m_springMass * this.m_dampingRatio * p + k * f), 0 < this.m_gamma && (this.m_gamma = 1 / this.m_gamma), this.m_bias = c * k * f * this.m_gamma,
            this.m_springMass = b + this.m_gamma, 0 < this.m_springMass && (this.m_springMass = 1 / this.m_springMass))) : this.m_springImpulse = 0;
    ...
    a.step.warmStarting ? (this.m_impulse *= a.step.dtRatio, this.m_springImpulse *= a.step.dtRatio, this.m_motorImpulse *= a.step.dtRatio, d = box2d.b2Add_V2_V2(box2d.b2Mul_S_V2(this.m_impulse, this.m_ay, box2d.b2Vec2.s_t0), box2d.b2Mul_S_V2(this.m_springImpulse,
...
box2d.b2WheelJoint.prototype.SolvePositionConstraints = function(a) {
    ...
    box2d.b2Sub_V2_V2(this.m_localAnchorB, this.m_localCenterB, this.m_lalcB);
    var g = box2d.b2Mul_R_V2(g, this.m_lalcB, this.m_rB),
        k = box2d.b2Add_V2_V2(box2d.b2Sub_V2_V2(d,
            b, box2d.b2Vec2.s_t0), box2d.b2Sub_V2_V2(g, h, box2d.b2Vec2.s_t1), box2d.b2WheelJoint.prototype.SolvePositionConstraints.s_d),
...
box2d.b2ParticleGroup.prototype.UpdateStatistics = function() {
    ...
    if (this.m_timestamp != this.m_system.m_timestamp) {
        ...
        0 < this.m_mass &&
            (d = 1 / this.m_mass, this.m_center.SelfMul(d), this.m_linearVelocity.SelfMul(d));
        this.m_angularVelocity = this.m_inertia = 0;
        for (d = this.m_firstIndex; d < this.m_lastIndex; d++) box2d.b2Sub_V2_V2(this.m_system.m_positionBuffer.data[d], this.m_center, a), box2d.b2Sub_V2_V2(this.m_system.m_velocityBuffer.data[d], this.m_linearVelocity, b), this.m_inertia += c * box2d.b2Dot_V2_V2(a, a), this.m_angularVelocity += c * box2d.b2Cross_V2_V2(a, b);
...
box2d.b2FixtureParticleQueryCallback.prototype.ReportFixture = function(a) {
    ...
    for (var b = a.GetShape().GetChildCount(), c = 0; c < b; c++)
        for (var d = a.GetAABB(c), d = this.m_system.GetInsideBoundsEnumerator(d), e; 0 <= (e = d.GetNext());) this.ReportFixtureAndParticle(a, c, e);
    return !0
};
...
box2d.b2ParticleSystem.prototype._ctor_ = function(a, b) {
    ...
    this.m_depthBuffer = [];
    this.m_colorBuffer =
        new box2d.b2ParticleSystem.UserOverridableBuffer;
    this.m_groupBuffer = [];
...
box2d.b2ParticleSystem.prototype.CreateParticle = function(a) {
    ...
    this.m_forceBuffer[b] = (this.m_forceBuffer[b] ||
        new box2d.b2Vec2).SetZero();
    ...
    c.index = b;
    c = a.group;
    if (this.m_groupBuffer[b] = c) c.m_firstIndex < c.m_lastIndex ? (this.RotateBuffer(c.m_firstIndex, c.m_lastIndex, b), box2d.b2Assert(c.m_lastIndex === b)) : c.m_firstIndex =
        b, c.m_lastIndex = b + 1;
...
box2d.b2ParticleSystem.prototype.CreateParticleGroup = function(a) {
    ...
    if (a.particleCount) {
        ...
        for (var d = 0; d < a.particleCount; d++) this.CreateParticleForGroup(a,
            b, a.positionData[d])
    }
    var e = this.m_count,
    ...
    a.group && (this.JoinParticleGroups(a.group,
        f), f = a.group);
    return f
};
...
box2d.b2ParticleSystem.prototype.JoinParticleGroups = function(a, b) {
    ...
    if (!this.m_world.IsLocked()) {
        ...
        this.UpdateContacts(!0);
        this.UpdatePairsAndTriads(a.m_firstIndex,
            b.m_lastIndex, c);
...
box2d.b2ParticleSystem.prototype.SetParticleFlags = function(a, b) {
    ...
    ~this.m_allParticleFlags & b && (b & box2d.b2ParticleFlag.b2_tensileParticle && (this.m_accumulation2Buffer = this.RequestBuffer(this.m_accumulation2Buffer)), b & box2d.b2ParticleFlag.b2_colorMixingParticle && (this.m_colorBuffer.data = this.RequestBuffer(this.m_colorBuffer.data)), this.m_allParticleFlags |= b);
...
box2d.b2ParticleSystem.prototype.SetParticleLifetime = function(a, b) {
    ...
    if (c)
        for (var c = this.GetParticleCount(), d = 0; d < c; ++d) this.m_indexByExpirationTimeBuffer.data[d] = d;
    c = b / this.m_def.lifetimeGranularity;
    c = 0 < c ? this.GetQuantizedTimeElapsed() +
        c : c;
...
box2d.b2ParticleSystem.prototype.ApplyForce = function(a, b, c) {
    ...
    if (box2d.b2ParticleSystem.IsSignificantForce(c))
        for (this.PrepareForceBuffer(), e = a; e < b; e++) this.m_forceBuffer[e].SelfAdd(c)
};
...
box2d.b2ParticleSystem.prototype.QueryAABB = function(a, b) {
    if (0 !== this.m_proxyBuffer.count)
        for (var c = this.m_proxyBuffer.count, d = box2d.std_lower_bound(this.m_proxyBuffer.data, 0, c, box2d.b2ParticleSystem.computeTag(this.m_inverseDiameter * b.lowerBound.x, this.m_inverseDiameter * b.lowerBound.y), box2d.b2ParticleSystem.Proxy.CompareProxyTag), c = box2d.std_upper_bound(this.m_proxyBuffer.data, d, c, box2d.b2ParticleSystem.computeTag(this.m_inverseDiameter * b.upperBound.x, this.m_inverseDiameter * b.upperBound.y), box2d.b2ParticleSystem.Proxy.CompareTagProxy),
...
box2d.b2ParticleSystem.prototype.RayCast = function(a, b, c) {
    ...
    if (0 !== this.m_proxyBuffer.count) {
        ...
        for (var f = box2d.b2Dot_V2_V2(c,
                c), d = this.GetInsideBoundsEnumerator(d), m; 0 <= (m = d.GetNext());) {
...
box2d.b2ParticleSystem.prototype.ReallocateInternalAllocatedBuffers = function(a) {
    ...
    if (this.m_internalAllocatedCapacity < a) {
        ...
        this.m_flagsBuffer.data = this.ReallocateBuffer4(this.m_flagsBuffer,
            this.m_internalAllocatedCapacity, a, !1);
        ...
        this.m_positionBuffer.data = this.ReallocateBuffer4(this.m_positionBuffer,
            this.m_internalAllocatedCapacity, a, !1);
        ...
        this.m_accumulationBuffer =
            this.ReallocateBuffer5(this.m_accumulationBuffer, 0, this.m_internalAllocatedCapacity, a, !1);
        ...
        this.m_groupBuffer = this.ReallocateBuffer5(this.m_groupBuffer, 0, this.m_internalAllocatedCapacity,
            a, !1);
...
box2d.b2ParticleSystem.prototype.CloneParticle = function(a, b) {
    ...
    if (this.m_handleIndexBuffer.data) {
        ...
        d && d.SetIndex(c);
        this.m_handleIndexBuffer.data[c] =
            d;
...
box2d.b2ParticleSystem.prototype.UpdatePairsAndTriads = function(a, b, c) {
    ...
    if (h & box2d.b2ParticleSystem.k_pairFlags)
        for (k = 0; k < this.m_contactBuffer.count; k++) {
            ...
            m >= a && m < b && n >= a && n < b && !((p | q) & box2d.b2ParticleFlag.b2_zombieParticle) && (p | q) & box2d.b2ParticleSystem.k_pairFlags && (c.IsNecessary(m) || c.IsNecessary(n)) && box2d.b2ParticleSystem.ParticleCanBeConnected(p, r) && box2d.b2ParticleSystem.ParticleCanBeConnected(q, u) && c.ShouldCreatePair(m, n) && (p = this.m_pairBuffer.data[this.m_pairBuffer.Append()], p.indexA = m, p.indexB = n, p.flags = l.flags, p.strength = box2d.b2Min(r ?
                r.m_strength : 1, u ? u.m_strength : 1), p.distance = box2d.b2Distance(g[m], g[n]));
    ...
    if (h & box2d.b2ParticleSystem.k_triadFlags) {
        ...
        l = 0;
        for (k = a; k < b; k++) m = this.m_flagsBuffer.data[k], n = this.m_groupBuffer[k], m & box2d.b2ParticleFlag.b2_zombieParticle || !box2d.b2ParticleSystem.ParticleCanBeConnected(m, n) || (c.IsNecessary(k) &&
            ++l, h.AddGenerator(g[k], k, c.IsNecessary(k)));
        if (0 === l)
            for (k = a; k < b; k++) c.IsNecessary(k);
        ...
        h.GetNodes(function(a, b, h) {
            ...
            if ((k | l | m) & box2d.b2ParticleSystem.k_triadFlags && c.ShouldCreateTriad(a, b, h)) {
                ...
                if (!(box2d.b2Dot_V2_V2(r,
                        r) > A || box2d.b2Dot_V2_V2(u, u) > A || box2d.b2Dot_V2_V2(C, C) > A)) {
...
box2d.b2ParticleSystem.prototype.ComputeDepth = function() {
    ...
    for (c = this.m_groupList; c; c = c.GetNext())
        if (c.m_groupFlags & box2d.b2ParticleGroupFlag.b2_particleGroupNeedsUpdateDepth)
            for (g[h++] = c, this.SetGroupFlags(c, c.m_groupFlags & ~box2d.b2ParticleGroupFlag.b2_particleGroupNeedsUpdateDepth),
                f = c.m_firstIndex; f < c.m_lastIndex; f++) this.m_accumulationBuffer[f] = 0;
    for (c = 0; c < b; c++) {
        var d = a[c],
            e = d.indexA,
            f = d.indexB,
    ...
    for (f = 0; f < h; f++)
        for (c = g[f], f = c.m_firstIndex; f < c.m_lastIndex; f++) k = this.m_accumulationBuffer[f], this.m_depthBuffer[f] = .8 > k ? 0 : box2d.b2_maxFloat;
    ...
    for (f = 0; f < h; f++)
        for (c = g[f], f = c.m_firstIndex; f < c.m_lastIndex; f++) this.m_depthBuffer[f] = this.m_depthBuffer[f] < box2d.b2_maxFloat ? this.m_depthBuffer[f] * this.m_particleDiameter : 0
};
...
box2d.b2ParticleSystem.prototype.FindContacts_Reference = function(a) {
    ...
    for (var b = this.m_contactBuffer.count = 0, c = 0; b < a; b++) {
        for (var d = box2d.b2ParticleSystem.computeRelativeTag(this.m_proxyBuffer.data[b].tag, 1, 0), e = b + 1; e < a && !(d < this.m_proxyBuffer.data[e].tag); e++) this.AddContact(this.m_proxyBuffer.data[b].index, this.m_proxyBuffer.data[e].index, this.m_contactBuffer);
        for (e = box2d.b2ParticleSystem.computeRelativeTag(this.m_proxyBuffer.data[b].tag,
                -1, 1); c < a && !(e <= this.m_proxyBuffer.data[c].tag); c++);
...
box2d.b2ParticleSystem.prototype.Solve = function(a) {
    ...
    if (0 !== this.m_count && (this.m_expirationTimeBuffer.data && this.SolveLifetimes(a), this.m_allParticleFlags & box2d.b2ParticleFlag.b2_zombieParticle && this.SolveZombie(), this.m_needsUpdateAllParticleFlags && this.UpdateAllParticleFlags(), this.m_needsUpdateAllGroupFlags && this.UpdateAllGroupFlags(), !this.m_paused))
        for (this.m_iterationIndex = 0; this.m_iterationIndex < a.particleIterations; this.m_iterationIndex++) {
            ...
            this.m_allParticleFlags &
                box2d.b2ParticleFlag.b2_repulsiveParticle && this.SolveRepulsive(c);
            ...
            this.SolveGravity(c);
            this.m_allParticleFlags & box2d.b2ParticleFlag.b2_staticPressureParticle &&
...
box2d.b2ParticleSystem.SolveCollisionCallback.prototype.ReportFixtureAndParticle = function(a, b, c) {
    ...
    0 === this.m_system.m_iterationIndex ? (d = box2d.b2MulT_X_V2(l.m_xf0, m, d), a.GetShape().GetType() === box2d.b2ShapeType.e_circleShape && (d.SelfSub(l.GetLocalCenter()), box2d.b2Mul_R_V2(l.m_xf0.q, d, d), box2d.b2MulT_R_V2(l.m_xf.q, d, d), d.SelfAdd(l.GetLocalCenter())), box2d.b2Mul_X_V2(l.m_xf, d, f.p1)) : f.p1.Copy(m);
    box2d.b2AddMul_V2_S_V2(m,
        this.m_step.dt, n, f.p2);
    f.maxFraction = 1;
    a.RayCast(e, f, b) && (a = e.normal, g.x = (1 - e.fraction) * f.p1.x + e.fraction * f.p2.x + box2d.b2_linearSlop * a.x, g.y = (1 - e.fraction) * f.p1.y + e.fraction * f.p2.y + box2d.b2_linearSlop * a.y, h.x = this.m_step.inv_dt * (g.x - m.x), h.y = this.m_step.inv_dt * (g.y - m.y), this.m_system.m_velocityBuffer.data[c].Copy(h), k.x = this.m_step.inv_dt * this.m_system.GetParticleMass() * (n.x - h.x), k.y = this.m_step.inv_dt * this.m_system.GetParticleMass() * (n.y - h.y), this.m_system.ParticleApplyForce(c, k))
};
...
box2d.b2ParticleSystem.prototype.SolveCollision = function(a) {
    ...
    for (var e = 0; e < this.m_count; e++) {
        ...
        d.lowerBound.y = box2d.b2Min(d.lowerBound.y, box2d.b2Min(g.y,
            f));
...
box2d.b2ParticleSystem.prototype.SolveBarrier = function(a) {
    for (var b = box2d.b2ParticleSystem.prototype.SolveBarrier.s_aabb, c = box2d.b2ParticleSystem.prototype.SolveBarrier.s_va, d = box2d.b2ParticleSystem.prototype.SolveBarrier.s_vb, e = box2d.b2ParticleSystem.prototype.SolveBarrier.s_pba, f = box2d.b2ParticleSystem.prototype.SolveBarrier.s_vba, g = box2d.b2ParticleSystem.prototype.SolveBarrier.s_vc, h = box2d.b2ParticleSystem.prototype.SolveBarrier.s_pca, k = box2d.b2ParticleSystem.prototype.SolveBarrier.s_vca, l = box2d.b2ParticleSystem.prototype.SolveBarrier.s_qba,
            m = box2d.b2ParticleSystem.prototype.SolveBarrier.s_qca, n = box2d.b2ParticleSystem.prototype.SolveBarrier.s_dv, p = box2d.b2ParticleSystem.prototype.SolveBarrier.s_f, q = this.m_positionBuffer.data, r = this.m_velocityBuffer.data, u = 0; u < this.m_count; u++) 0 !== (this.m_flagsBuffer.data[u] & box2d.b2ParticleSystem.k_barrierWallFlags) && r[u].SetZero();
            ...
            for (var E = this.m_groupBuffer[v], F = this.m_groupBuffer[y], v = this.GetLinearVelocity(E, v, x, c), y = this.GetLinearVelocity(F, y, z, d), z = box2d.b2Sub_V2_V2(z, x, e), y = box2d.b2Sub_V2_V2(y, v, f), B = this.GetInsideBoundsEnumerator(B), G; 0 <= (G = B.GetNext());) {
                ...
                if (E !== I && F !== I) {
                    ...
                    if (0 === J) {
                        ...
                        box2d.b2AddMul_V2_S_V2(z, L, y, M);
                        box2d.b2AddMul_V2_S_V2(A, L, K, N);
                        D = box2d.b2Dot_V2_V2(M, N) / box2d.b2Dot_V2_V2(M,
                            M);
                        if (!(0 <= L && L < u && 0 <= D && 1 >= D)) {
                            L = J;
                            if (!(0 <= L && L < u)) continue;
                    ...
                    this.IsRigidGroup(I) ? (t = I.GetMass(), A = I.GetInertia(), 0 < t && I.m_linearVelocity.SelfMulAdd(1 / t, C), 0 < A && (I.m_angularVelocity += box2d.b2Cross_V2_V2(box2d.b2Sub_V2_V2(H, I.GetCenter(), box2d.b2Vec2.s_t0), C) / A)) : r[G].SelfAdd(A);
                    this.ParticleApplyForce(G,
                        C.SelfMul(-a.inv_dt))
                }
            }
        }
...
box2d.b2ParticleSystem.prototype.SolveStaticPressure = function(a) {
    ...
    for (var b = box2d.b2_maxParticlePressure * b, c = this.m_def.staticPressureRelaxation, d = 0; d < this.m_def.staticPressureIterations; d++) {
        ...
        for (e = 0; e < this.m_count; e++) f = this.m_weightBuffer[e], this.m_staticPressureBuffer[e] = this.m_flagsBuffer.data[e] & box2d.b2ParticleFlag.b2_staticPressureParticle ? box2d.b2Clamp((this.m_accumulationBuffer[e] + a * (f - box2d.b2_minParticleWeight)) / (f + c), 0, b) : 0
    }
};
...
box2d.b2ParticleSystem.prototype.SolvePressure = function(a) {
    ...
    if (this.m_allParticleFlags & box2d.b2ParticleSystem.k_noPressureFlags)
        for (h = 0; h < this.m_count; h++) this.m_flagsBuffer.data[h] &
            box2d.b2ParticleSystem.k_noPressureFlags && (this.m_accumulationBuffer[h] = 0);
    if (this.m_allParticleFlags & box2d.b2ParticleFlag.b2_staticPressureParticle)
        for (box2d.b2Assert(null !== this.m_staticPressureBuffer), h = 0; h < this.m_count; h++) this.m_flagsBuffer.data[h] & box2d.b2ParticleFlag.b2_staticPressureParticle && (this.m_accumulationBuffer[h] += this.m_staticPressureBuffer[h]);
    ...
    for (h = 0; h < this.m_contactBuffer.count; h++) k = this.m_contactBuffer.data[h], l = k.indexA, m = k.indexB, e = k.weight, p = k.normal, k = this.m_accumulationBuffer[l] + this.m_accumulationBuffer[m], e = box2d.b2Mul_S_V2(a * e * k, p, b), d[l].SelfSub(e), d[m].SelfAdd(e)
};
...
box2d.b2ParticleSystem.prototype.SolveDamping = function(a) {
    ...
    for (var g = this.GetParticleInvMass(), h = 0; h < this.m_bodyContactBuffer.count; h++) {
        var k = this.m_bodyContactBuffer.data[h],
            ...
            q = k.normal,
            k = d[l],
            r = box2d.b2Sub_V2_V2(m.GetLinearVelocityFromWorldPoint(k,
                box2d.b2Vec2.s_t0), e[l], b),
            r = box2d.b2Dot_V2_V2(r, q);
        0 > r && (n = box2d.b2Max(f * n, box2d.b2Min(-a * r, .5)), p = box2d.b2Mul_S_V2(n * p * r, q, c), e[l].SelfMulAdd(g, p), m.ApplyLinearImpulse(p.SelfNeg(), k, !0))
    }
    for (h = 0; h < this.m_contactBuffer.count; h++) k = this.m_contactBuffer.data[h], l = k.indexA, m = k.indexB, n = k.weight, q = k.normal, r = box2d.b2Sub_V2_V2(e[m], e[l], b), r = box2d.b2Dot_V2_V2(r, q), 0 > r && (n = box2d.b2Max(f * n, box2d.b2Min(-a * r, .5)), p = box2d.b2Mul_S_V2(n * r, q, c), e[l].SelfAdd(p), e[m].SelfSub(p))
};
...
box2d.b2ParticleSystem.prototype.SolveRigidDamping = function() {
    for (var a = box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_t0, b = box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_t1, c = box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_p, d = box2d.b2ParticleSystem.prototype.SolveRigidDamping.s_v, e = [0], f = [0], g = [0], h = [0], k = [0], l = [0], m = this.m_positionBuffer.data, n = this.m_def.dampingStrength, p = 0; p < this.m_bodyContactBuffer.count; p++) {
        ...
        if (this.IsRigidGroup(u)) {
            ...
            0 > v && (this.InitDampingParameterWithRigidGroupOrParticle(e, f, g, !0, u, r, q, w), this.InitDampingParameter(h, k, l, t.GetMass(), t.GetInertia() - t.GetMass() * t.GetLocalCenter().LengthSquared(), t.GetWorldCenter(), q, w), x = n * box2d.b2Min(x, 1) * this.ComputeDampingImpulse(e[0], f[0], g[0], h[0], k[0], l[0], v), this.ApplyDamping(e[0],
                f[0], g[0], !0, u, r, x, w), t.ApplyLinearImpulse(box2d.b2Mul_S_V2(-x, w, box2d.b2Vec2.s_t0), q, !0))
        }
    }
    for (p = 0; p < this.m_contactBuffer.count; p++) {
        ...
        u !== y && (z || B) && (q = box2d.b2Mid_V2_V2(m[r], m[t], c), v = box2d.b2Sub_V2_V2(this.GetLinearVelocity(y, t, q, a), this.GetLinearVelocity(u, r, q, b), d), v = box2d.b2Dot_V2_V2(v, w), 0 > v && (this.InitDampingParameterWithRigidGroupOrParticle(e,
            f, g, z, u, r, q, w), this.InitDampingParameterWithRigidGroupOrParticle(h, k, l, B, y, t, q, w), x = n * x * this.ComputeDampingImpulse(e[0], f[0], g[0], h[0], k[0], l[0], v), this.ApplyDamping(e[0], f[0], g[0], z, u, r, x, w), this.ApplyDamping(h[0], k[0], l[0], B, y, t, -x, w)))
    }
};
    ...
    for (var a = box2d.b2ParticleSystem.prototype.SolveExtraDamping.s_v, b = box2d.b2ParticleSystem.prototype.SolveExtraDamping.s_f, c = this.m_velocityBuffer.data, d = this.m_positionBuffer.data, e = this.GetParticleInvMass(), f = 0; f < this.m_bodyContactBuffer.count; f++) {
        ...
        if (this.m_flagsBuffer.data[h] & box2d.b2ParticleSystem.k_extraDampingFlags) {
            var k = g.body,
                ...
                m = g.normal,
                g = d[h],
                n = box2d.b2Sub_V2_V2(k.GetLinearVelocityFromWorldPoint(g,
                    box2d.b2Vec2.s_t0), c[h], a),
                n = box2d.b2Dot_V2_V2(n, m);
            0 > n && (l = box2d.b2Mul_S_V2(.5 * l * n, m, b), c[h].SelfMulAdd(e, l), k.ApplyLinearImpulse(l.SelfNeg(), g, !0))
        }
    }
};
    ...
    for (var a = box2d.b2ParticleSystem.prototype.SolveViscous.s_v, b = box2d.b2ParticleSystem.prototype.SolveViscous.s_f, c = this.m_positionBuffer.data, d = this.m_velocityBuffer.data, e = this.m_def.viscousStrength, f = this.GetParticleInvMass(), g = 0; g < this.m_bodyContactBuffer.count; g++) {
        ...
        if (this.m_flagsBuffer.data[k] & box2d.b2ParticleFlag.b2_viscousParticle) {
            var l = h.body,
                ...
                n = h.mass,
                h = c[k],
                p = box2d.b2Sub_V2_V2(l.GetLinearVelocityFromWorldPoint(h,
                    box2d.b2Vec2.s_t0), d[k], a),
                m = box2d.b2Mul_S_V2(e * n * m, p, b);
            d[k].SelfMulAdd(f, m);
            l.ApplyLinearImpulse(m.SelfNeg(), h, !0)
        }
    }
    for (g = 0; g < this.m_contactBuffer.count; g++) h = this.m_contactBuffer.data[g], h.flags & box2d.b2ParticleFlag.b2_viscousParticle && (k = h.indexA, l = h.indexB, m = h.weight, p = box2d.b2Sub_V2_V2(d[l], d[k], a), m = box2d.b2Mul_S_V2(e * m, p, b), d[k].SelfAdd(m), d[l].SelfSub(m))
};
...
box2d.b2ParticleSystem.prototype.SolvePowder = function(a) {
    ...
    for (g = 0; g < this.m_contactBuffer.count; g++) h = this.m_contactBuffer.data[g], h.flags & box2d.b2ParticleFlag.b2_powderParticle && (l = h.weight, l > e && (k = h.indexA, m = h.indexB, p = h.normal, h = box2d.b2Mul_S_V2(a * (l - e), p, b), d[k].SelfSub(h), d[m].SelfAdd(h)))
};
    ...
    for (var d = 0, c = 0; c < this.m_count; c++) {
        ...
        if (e & box2d.b2ParticleFlag.b2_zombieParticle) {
            ...
            this.m_consecutiveContactStepsBuffer.data && (this.m_consecutiveContactStepsBuffer.data[a] = this.m_consecutiveContactStepsBuffer.data[c]), this.m_positionBuffer.data[a].Copy(this.m_positionBuffer.data[c]), this.m_velocityBuffer.data[a].Copy(this.m_velocityBuffer.data[c]), this.m_groupBuffer[a] = this.m_groupBuffer[c], this.m_hasForce && this.m_forceBuffer[a].Copy(this.m_forceBuffer[c]), this.m_staticPressureBuffer && (this.m_staticPressureBuffer[a] = this.m_staticPressureBuffer[c]), this.m_depthBuffer && (this.m_depthBuffer[a] =
                this.m_depthBuffer[c]), this.m_colorBuffer.data && this.m_colorBuffer.data[a].Copy(this.m_colorBuffer.data[c]), this.m_userDataBuffer.data && (this.m_userDataBuffer.data[a] = this.m_userDataBuffer.data[c]), this.m_expirationTimeBuffer.data && (this.m_expirationTimeBuffer.data[a] = this.m_expirationTimeBuffer.data[c])), a++, d |= e
    }
    for (c = 0; c < this.m_proxyBuffer.count; c++) e = this.m_proxyBuffer.data[c], e.index = b[e.index];
    this.m_proxyBuffer.RemoveIf(function(a) {
        return 0 > a.index
    });
    for (c = 0; c < this.m_contactBuffer.count; c++) e =
        this.m_contactBuffer.data[c], e.indexA = b[e.indexA], e.indexB = b[e.indexB];
    this.m_contactBuffer.RemoveIf(function(a) {
...
box2d.b2ParticleSystem.prototype.RotateBuffer = function(a, b, c) {
    ...
    if (a !== b && b !== c) {
        ...
        this.m_consecutiveContactStepsBuffer.data && box2d.std_rotate(this.m_consecutiveContactStepsBuffer.data,
            a, b, c);
        ...
        this.m_userDataBuffer.data && box2d.std_rotate(this.m_userDataBuffer.data,
            a, b, c);
        if (this.m_handleIndexBuffer.data) {
        ...
        for (e = 0; e < this.m_contactBuffer.count; e++) f =
            this.m_contactBuffer.data[e], f.indexA = d(f.indexA), f.indexB = d(f.indexB);
        ...
        for (e = this.m_groupList; e; e = e.GetNext()) e.m_firstIndex = d(e.m_firstIndex), e.m_lastIndex = d(e.m_lastIndex -
            1) + 1
    }
};
...
box2d.b2ParticleSystem.prototype.RemoveSpuriousBodyContacts = function() {
    ...
    var a = box2d.b2ParticleSystem.prototype.RemoveSpuriousBodyContacts.s_n,
        ...
        f = 0,
        g = 0;
    this.m_bodyContactBuffer.count = box2d.std_remove_if(this.m_bodyContactBuffer.data,
        function(h) {
            ...
            if (!h.fixture.TestPoint(k)) {
                for (var l = h.fixture.GetShape().GetChildCount(), m = 0; m < l; m++)
                    if (h.fixture.ComputeDistance(k, c, m) < box2d.b2_linearSlop) return !1;
                ++g;
                return !0
            }
            return !1
...
box2d.b2ParticleSystem.prototype.DetectStuckParticle = function(a) {
    0 >= this.m_stuckThreshold || (++this.m_bodyContactCountBuffer.data[a], 2 === this.m_bodyContactCountBuffer.data[a] && (++this.m_consecutiveContactStepsBuffer.data[a], this.m_consecutiveContactStepsBuffer.data[a] > this.m_stuckThreshold && (this.m_stuckParticleBuffer.data[this.m_stuckParticleBuffer.Append()] = a)), this.m_lastBodyContactStepBuffer.data[a] = this.m_timestamp)
};
...
box2d.b2VoronoiDiagram.prototype.Generate = function(a, b) {
    ...
    if (0 === f) this.m_countY = this.m_countX = 0;
        ...
        for (; !e.Empty();) g = e.Front(), f = g.m_x, k = g.m_y, c = g.m_i, h = g.m_generator, e.Pop(), this.m_diagram[c] ||
            (this.m_diagram[c] = h, 0 < f && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f - 1, k, c - 1, h)), 0 < k && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k - 1, c - this.m_countX, h)), f < this.m_countX - 1 && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f + 1, k, c + 1, h)), k < this.m_countY - 1 && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k + 1, c + this.m_countX, h)));
        for (k = 0; k < this.m_countY; k++)
            for (f = 0; f < this.m_countX - 1; f++) c = f + k * this.m_countX, d = this.m_diagram[c], g = this.m_diagram[c + 1], d !== g && (e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f,
                k, c, g)), e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f + 1, k, c + 1, d)));
        for (k = 0; k < this.m_countY - 1; k++)
            for (f = 0; f < this.m_countX; f++) c = f + k * this.m_countX, d = this.m_diagram[c], g = this.m_diagram[c + this.m_countX], d !== g && (e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k, c, g)), e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k + 1, c + this.m_countX, d)));
        for (; !e.Empty();)
            if (g = e.Front(), f = g.m_x, k = g.m_y, c = g.m_i, g = g.m_generator, e.Pop(), d = this.m_diagram[c], d !== g) {
                var h = d.center.x - f,
                    ...
                    l = g.center.x - f,
                    m = g.center.y - k;
                h * h + d * d > l * l + m * m && (this.m_diagram[c] = g, 0 < f && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f - 1, k, c - 1, g)), 0 < k && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k - 1, c - this.m_countX, g)), f < this.m_countX - 1 && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f + 1, k, c + 1, g)), k < this.m_countY - 1 && e.Push(new box2d.b2VoronoiDiagram.b2VoronoiDiagramTask(f, k + 1, c + this.m_countX, g)))
            }
    }
};
...
box2d.b2Rope.prototype.Initialize = function(a) {
    ...
    for (b = 0; b < c; ++b) e = this.m_ps[b], f = this.m_ps[b + 1], d = this.m_ps[b + 2], e = box2d.b2Sub_V2_V2(f, e, box2d.b2Vec2.s_t0), d = box2d.b2Sub_V2_V2(d, f, box2d.b2Vec2.s_t1), f = box2d.b2Cross_V2_V2(e, d), e = box2d.b2Dot_V2_V2(e, d), this.m_as[b] = box2d.b2Atan2(f, e);
    ...
    if (this.m_bodyList)
        for (this.useWorldGravity && this.gravity.Copy(this.GetWorld().GetGravity()), a = this.m_bodyList; a; a = a.nextBody) {
            ...
            if (b.IsAwake()) {
                ...
                d.x /= f;
                d.y /= f;
                e < box2d.b2_epsilon || (f = this.gravity.Clone().SelfNeg(), f.SelfMul(this.density * e), b.ApplyForce(f, d), d = b.GetLinearVelocityFromWorldPoint(c, new box2d.b2Vec2), d.SelfSub(this.velocity), d.SelfMul(-this.linearDrag * e), b.ApplyForce(d, c), b.ApplyTorque(-b.GetInertia() / b.GetMass() * e * b.GetAngularVelocity() * this.angularDrag))
            }
        }
};
    ...
    if (this.invSqr)
        for (a = this.m_bodyList; a; a = a.nextBody)
            for (var b = a.body, c = b.GetWorldCenter(), d = b.GetMass(), e = this.m_bodyList; e !== a; e = e.nextBody) {
                ...
                for (a = this.m_bodyList; a; a = a.nextBody)
                    for (b =
                        a.body, c = b.GetWorldCenter(), d = b.GetMass(), e = this.m_bodyList; e !== a; e = e.nextBody) f = e.body, g = f.GetWorldCenter(), h = f.GetMass(), k = g.x - c.x, l = g.y - c.y, m = k * k + l * l, m < box2d.b2_epsilon || (k = box2d.b2GravityController.prototype.Step.s_f.Set(k, l), k.SelfMul(this.G / m * d * h), b.IsAwake() && b.ApplyForce(k, c), f.IsAwake() && f.ApplyForce(k.SelfMul(-1), g))
};
    ...
    if (!(a <= box2d.b2_epsilon)) {
        ...
        for (var b = this.m_bodyList; b; b = b.nextBody) {
            ...
            if (c.IsAwake()) {
                ...
                c.SetLinearVelocity(box2d.b2Add_V2_V2(c.GetLinearVelocity(), box2d.b2Mul_S_V2(a, d, box2d.b2Vec2.s_t0),
                    box2d.b2Vec2.s_t1))
            }
        }
    }
